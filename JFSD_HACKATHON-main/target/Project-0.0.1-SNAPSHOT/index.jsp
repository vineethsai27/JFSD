...
<body >
  ...
  <div class="container">
   ...
   <b> <h1 style="font-family: 'Poiret One', sans-serif; text-transform: uppercase;">GET STARTED</h1>
      ...
      <a href="#">
        <button class="create-blog-button">Start Your Day With Fresh Blogging</button>
      </a>
      <!-- 
      <a href="#">
        <button class="create-blog-button">Blogging is a popular and enjoyed by 
          people around the world.</button> -->
      </a>
